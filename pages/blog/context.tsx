      ...
      <main className="mx-auto lg:w-1/2 lg:mx-auto md:mx-24 w-full lg:text-center text-left">
        ...
        <div className='text-white text-left mx-5 mb-24'>
            ...
            <div className='flex justify-center'>
              ...
              <p>The second issue is that increasing simply increasing the context window isn&apos;t as much of a magical silver bullet for existing LLM problems as you might think. In Chelsy Ma&apos;s article on {styledLink("whether large context windows are a trend", "https://medium.com/@machangsha/foundation-model-101-is-large-context-window-a-trend-22e352201099")}, she points out that &quot;expanding the context window alone contradicts Lev Vygotsky&apos;s {styledLink("Zone of Proximal Development", "https://en.wikipedia.org/wiki/Zone_of_proximal_development")} (ZPD) theory.&quot; Now what on earth does that mean?</p>
              ...
              <p>External Search can be widely defined as empowering LLMs to search for and retrieve the exact information they need within a large data set without directly inspecting all of the data during every inference time.</p>
              ...
              <p>As time progresses, models with million token context windows and beyond will certainly emerge. However, until breakthroughs that mitigate the aforementioned issues occur, an enlarged context window should not be treated as the silver bullet.</p>
