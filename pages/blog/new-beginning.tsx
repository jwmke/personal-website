      ...
      <main className="mx-auto lg:w-1/2 lg:mx-auto md:mx-24 w-full lg:text-center text-left">
        ...
        <div className='text-white text-left mx-5 mb-24'>
            ...
            <div className='text-xl child:mt-5 mt-8'>
              ...
              <p>By now, you might be thinking I&apos;m just using this post to cope with my recent departure from university, and you might assume the impression that I&apos;m not aware of how privileged I am to be in my position. While I believe I&apos;ve worked hard to get to where I am, it&apos;s not my place to agree or disagree with this assumption. However, one thing is certain, there&apos;s never a reason to not strive to be better, even when coming from a place of privilege.</p>
              <p>Throughout university, the concept of self-betterment became a topic that I became particularly engaged with, and with good reason. Through the effort of attempting to live every day 1% better than the last, as opposed to simply doing what was expedient, my self-esteem grew, my mental health improved, and I was steadily moving closer to my own definition of success.</p>
              ...
              <p>But how does one craft their own definition of success, you might ask? In my opinion, this is one of the most complex, multivariable inquiries that can be asked. It&apos;s synonymous with determining the meaning of life, and nearly every person on the planet will have a varying answer. Nonetheless, I&apos;ll attempt to solicit some guidance on how to begin to approach the question.</p>
              <p>First, understand that your answer must be malleable and will therefore change over the course of your life, so there&apos;s no purpose in stressing about now having your perfect answer now. When formulating your answer, you&apos;ll want to consider both your values and your aspirations in life. These are the elements in life that are truly the most important to you and the corresponding goals that meaningfully align with them.</p>
