      ...
      <main className="mx-auto lg:w-1/2 lg:mx-auto md:mx-24 w-full lg:text-center text-left select-none">
        ...
        <div className='text-white text-left mx-5 mb-24'>
            ...
            <div className='text-xl child:mt-5 mt-8'>
              ...
              <p>Narrowing my attention to the short-term future, I could only focus on what was going to be lost upon graduating. I progressively became more aware of everything that I had been taking for granted; as I did, it felt like the world around me was collapsing in on itself.</p>
              ...
              <p>But how does one craft their own definition of success? In my opinion, this is one of the most complex, multivariable questions that can be asked. It is synonymous with determining the meaning of life, and nearly every person on the planet will have a varying answer. Nonetheless, I&apos;ll attempt to solicit some guidance on how you can begin to approach the question.</p>
