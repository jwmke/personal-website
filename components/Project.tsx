...
const Project = (props: {
    ...
    return (
        <>
            <div onClick={() => setShowModal(!showModal)} className="max-w-sm mr-3 rounded overflow-hidden shadow-2xl bg-mint mb-24 transition ease-linear duration-150 hover:scale-105 hover:cursor-pointer hover:bg-white">
